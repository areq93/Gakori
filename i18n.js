...
const TRANSLATIONS = {
    ...
    ar: {
        ...
        scan_pdf_source_label: "الملف: ", pattern_page_label: "الصفحة {page}", pattern_image_label: "الصورة {index}", link_pdf_history: "تحليلاتك الخاصة →", history_back: "← العودة إلى الحساب", history_title: "تحليلاتك الخاصة", history_intro: "أنت فقط من يرى هذه القائمة — هذه التحليلات ليست عامة.", history_empty: "ليس لديك أي تحليل خاص بعد.", history_unnamed_file: "ملف بدون اسم", history_section_pdf: "PDF", history_section_image: "الصور", history_section_text: "نصوص خاصة", history_unnamed_image: "صورة بدون اسم", history_unnamed_text: "نص خاص", history_search_placeholder: "ابحث في جميع تحليلاتك...", history_no_match: "لا توجد نتائج لهذا البحث.", label_text_private: "احتفظ بهذا التحليل كخاص (يظهر لك فقط)",
