...
const TRANSLATIONS = {
    pl: {
        ...
        account_aria_label: "Twoje konto", credit_balance_label: "Stan kredytów", account_back: "Wstecz", account_title: "Twoje konto",
        ...
        alert_enter_link: "Wpisz link!", alert_invalid_link: "To nie wygląda na prawidłowy link — musi zaczynać się od http:// albo https://", alert_paste_text: "Wklej jakiś tekst!", alert_choose_image: "Wybierz obraz!", alert_image_too_large: "Ten plik jest za duży (limit 8 MB).",
        ...
        err_url_fetch_failed: "Nie udało się pobrać treści tej strony — problemy tego typu zdarzają się, kiedy mamy do czynienia z blokadą po stronie serwisu (np. ochrona antybotowa). Sprawdź, czy link jest poprawny i publicznie dostępny. Możesz też skopiować treść artykułu, wkleić ją w trybie „Tekst” i podać tam ten sam link w polu „Opcjonalnie: link do źródła” — zadziała niezależnie od tego problemu, a tym samym pomożesz też innym, którzy wkleją ten sam link.",
        ...
        err_too_many_failed_attempts: "Zbyt wiele nieudanych prób analizy pod rząd (poziom blokady: {tier}). Spróbuj ponownie za {time}.",
        ...
        scan_not_found: "Nie znaleziono takiej analizy.", scan_source_label: "Źródło: ", scan_text_source_label: "Pokaż pełny tekst źródłowy", scan_text_source_char_count: "{count} znaków",
        ...
        scan_pdf_source_label: "Plik: ", pattern_page_label: "Strona {page}", pattern_image_label: "Obraz {index}", link_pdf_history: "Twoje analizy →", history_back: "Wstecz", history_title: "Twoje analizy", history_intro: "Wszystkie analizy, które kiedykolwiek zrobiłeś. Prywatne są oznaczone znaczkiem 🔒.", history_empty: "Nie masz jeszcze żadnych analiz.", history_unnamed_file: "plik bez nazwy", history_section_pdf: "PDF-y", history_section_image: "Obrazy", history_section_text: "Teksty", history_unnamed_image: "obraz bez nazwy", history_unnamed_text: "tekst bez tytułu", history_search_placeholder: "Szukaj we wszystkich swoich analizach...", history_no_match: "Brak wyników dla tego wyszukiwania.", history_private_badge: "🔒 Prywatna", history_section_url: "Linki", history_unnamed_url: "link bez tytułu", history_filter_all: "Wszystkie", history_filter_public: "Publiczne", history_filter_private: "Prywatne", label_text_private: "Zachowaj tę analizę jako prywatną (widoczna tylko dla Ciebie)",
    ...
    en: {
        ...
        account_aria_label: "Your account", credit_balance_label: "Credit balance", account_back: "Back", account_title: "Your account",
        ...
        alert_enter_link: "Enter a link!", alert_invalid_link: "That doesn't look like a valid link — it must start with http:// or https://", alert_paste_text: "Paste some text!", alert_choose_image: "Choose an image!", alert_image_too_large: "This file is too large (8 MB limit).",
        ...
        err_url_fetch_failed: "We couldn't fetch this page — this kind of issue happens when the source site itself blocks automated access (e.g. anti-bot protection). Check that the link is correct and publicly accessible. You can also copy the article text, paste it in \"Text\" mode, and add the same link in the \"Optional: source link\" field — that works regardless of this issue, and it helps others who paste the same link too.",
        err_system_paused: "Gakori is temporarily paused — our team already knows and is working on it. Please try again shortly.",
        err_login_required: "This content is private — log in to see it.",
        notice_privatize_denied: "This content was already public before, so it can't be made private now — here's the public result.",
        err_save_failed: "We couldn't save the analysis result. Please try again.",
        err_too_many_failed_attempts: "Too many failed analysis attempts in a row (block level: {tier}). Try again in {time}.",
        ...
        scan_not_found: "This analysis could not be found.", scan_source_label: "Source: ", scan_text_source_label: "Show full source text", scan_text_source_char_count: "{count} characters",
        ...
        scan_pdf_source_label: "File: ", pattern_page_label: "Page {page}", pattern_image_label: "Image {index}", link_pdf_history: "Your analyses →", history_back: "Back", history_title: "Your analyses", history_intro: "All the analyses you've ever done. Private ones are marked with 🔒.", history_empty: "You don't have any analyses yet.", history_unnamed_file: "unnamed file", history_section_pdf: "PDFs", history_section_image: "Images", history_section_text: "Texts", history_unnamed_image: "unnamed image", history_unnamed_text: "untitled text", history_search_placeholder: "Search all your analyses...", history_no_match: "No results for this search.", history_private_badge: "🔒 Private", history_section_url: "Links", history_unnamed_url: "untitled link", history_filter_all: "All", history_filter_public: "Public", history_filter_private: "Private", label_text_private: "Keep this analysis private (visible only to you)",
    ...
    es: {
        ...
        account_aria_label: "Tu cuenta", credit_balance_label: "Créditos disponibles", account_back: "Atrás", account_title: "Tu cuenta",
        ...
        alert_enter_link: "¡Escribe un enlace!", alert_invalid_link: "Esto no parece un enlace válido — debe empezar con http:// o https://", alert_paste_text: "¡Pega algún texto!", alert_choose_image: "¡Elige una imagen!", alert_image_too_large: "Este archivo es demasiado grande (límite 8 MB).",
        status_err_prefix: "❌ Error: ",
        ...
        err_url_fetch_failed: "No pudimos obtener el contenido de esta página — este tipo de problema ocurre cuando el propio sitio bloquea el acceso automático (por ejemplo, protección antibots). Comprueba que el enlace sea correcto y esté disponible públicamente. También puedes copiar el texto del artículo, pegarlo en el modo «Texto» y añadir ese mismo enlace en el campo «Opcional: enlace de la fuente» — funciona independientemente de este problema, y así también ayudas a otras personas que peguen el mismo enlace.",
        ...
        err_login_required: "Este contenido es privado — inicia sesión para verlo.",
        notice_privatize_denied: "Este contenido ya era público antes, así que no se puede hacer privado ahora — aquí tienes el resultado público.",
        err_save_failed: "No se pudo guardar el resultado del análisis. Inténtalo de nuevo.",
        err_too_many_failed_attempts: "Demasiados intentos de análisis fallidos seguidos (nivel de bloqueo: {tier}). Vuelve a intentarlo en {time}.",
        ...
        scan_not_found: "No se encontró este análisis.", scan_source_label: "Fuente: ", scan_text_source_label: "Mostrar el texto fuente completo", scan_text_source_char_count: "{count} caracteres",
        ...
        scan_pdf_source_label: "Archivo: ", pattern_page_label: "Página {page}", pattern_image_label: "Imagen {index}", link_pdf_history: "Tus análisis →", history_back: "Atrás", history_title: "Tus análisis", history_intro: "Todos los análisis que has hecho alguna vez. Los privados están marcados con 🔒.", history_empty: "Todavía no tienes ningún análisis.", history_unnamed_file: "archivo sin nombre", history_section_pdf: "PDF", history_section_image: "Imágenes", history_section_text: "Textos", history_unnamed_image: "imagen sin nombre", history_unnamed_text: "texto sin título", history_search_placeholder: "Buscar en todos tus análisis...", history_no_match: "Sin resultados para esta búsqueda.", history_private_badge: "🔒 Privado", history_section_url: "Enlaces", history_unnamed_url: "enlace sin título", history_filter_all: "Todos", history_filter_public: "Públicos", history_filter_private: "Privados", label_text_private: "Guardar este análisis como privado (solo tú lo verás)",
    ...
    de: {
        ...
        account_aria_label: "Dein Konto", credit_balance_label: "Guthaben", account_back: "Zurück", account_title: "Dein Konto",
        ...
        alert_enter_link: "Bitte einen Link eingeben!", alert_invalid_link: "Das sieht nicht wie ein gültiger Link aus — er muss mit http:// oder https:// beginnen.", alert_paste_text: "Bitte einen Text einfügen!", alert_choose_image: "Bitte ein Bild auswählen!", alert_image_too_large: "Diese Datei ist zu groß (Limit 8 MB).",
        ...
        err_url_fetch_failed: "Wir konnten den Inhalt dieser Seite nicht abrufen — solche Probleme treten auf, wenn die Seite selbst automatisierte Zugriffe blockiert (z. B. durch einen Anti-Bot-Schutz). Prüfe, ob der Link korrekt und öffentlich zugänglich ist. Du kannst den Artikeltext auch kopieren, ihn im Modus „Text“ einfügen und denselben Link im Feld „Optional: Quellenlink“ angeben — das funktioniert unabhängig von diesem Problem und hilft damit auch anderen, die denselben Link einfügen.",
        ...
        err_login_required: "Dieser Inhalt ist privat — melde dich an, um ihn zu sehen.",
        notice_privatize_denied: "Dieser Inhalt war bereits öffentlich, kann jetzt also nicht privat gemacht werden — hier ist das öffentliche Ergebnis.",
        err_save_failed: "Das Analyseergebnis konnte nicht gespeichert werden. Bitte versuche es erneut.",
        err_too_many_failed_attempts: "Zu viele fehlgeschlagene Analyseversuche hintereinander (Sperrstufe: {tier}). Versuche es in {time} erneut.",
        ...
        scan_not_found: "Diese Analyse wurde nicht gefunden.", scan_source_label: "Quelle: ", scan_text_source_label: "Vollständigen Quelltext anzeigen", scan_text_source_char_count: "{count} Zeichen",
        ...
        scan_pdf_source_label: "Datei: ", pattern_page_label: "Seite {page}", pattern_image_label: "Bild {index}", link_pdf_history: "Deine Analysen →", history_back: "Zurück", history_title: "Deine Analysen", history_intro: "Alle Analysen, die du je gemacht hast. Private sind mit 🔒 markiert.", history_empty: "Du hast noch keine Analysen.", history_unnamed_file: "Datei ohne Namen", history_section_pdf: "PDFs", history_section_image: "Bilder", history_section_text: "Texte", history_unnamed_image: "Bild ohne Namen", history_unnamed_text: "Text ohne Titel", history_search_placeholder: "In allen deinen Analysen suchen...", history_no_match: "Keine Ergebnisse für diese Suche.", history_private_badge: "🔒 Privat", history_section_url: "Links", history_unnamed_url: "Link ohne Titel", history_filter_all: "Alle", history_filter_public: "Öffentlich", history_filter_private: "Privat", label_text_private: "Diese Analyse privat halten (nur für dich sichtbar)",
    ...
    fr: {
        ...
        account_aria_label: "Votre compte", credit_balance_label: "Solde de crédits", account_back: "Retour", account_title: "Votre compte",
        ...
        alert_enter_link: "Entrez un lien !", alert_invalid_link: "Cela ne ressemble pas à un lien valide — il doit commencer par http:// ou https://", alert_paste_text: "Collez du texte !", alert_choose_image: "Choisissez une image !", alert_image_too_large: "Ce fichier est trop volumineux (limite 8 Mo).",
        ...
        err_url_fetch_failed: "Impossible de récupérer le contenu de cette page — ce type de problème survient lorsque le site lui-même bloque les accès automatisés (par exemple une protection anti-robots). Vérifiez que le lien est correct et accessible publiquement. Vous pouvez aussi copier le texte de l'article, le coller en mode « Texte » et ajouter ce même lien dans le champ « Facultatif : lien source » — cela fonctionne indépendamment de ce problème, et cela aide aussi les autres personnes qui colleront le même lien.",
        ...
        err_login_required: "Ce contenu est privé — connectez-vous pour le voir.",
        notice_privatize_denied: "Ce contenu était déjà public, il ne peut donc pas être rendu privé maintenant — voici le résultat public.",
        err_save_failed: "Impossible d'enregistrer le résultat de l'analyse. Veuillez réessayer.",
        err_too_many_failed_attempts: "Trop de tentatives d'analyse échouées d'affilée (niveau de blocage : {tier}). Réessayez dans {time}.",
        ...
        scan_not_found: "Cette analyse est introuvable.", scan_source_label: "Source : ", scan_text_source_label: "Afficher le texte source complet", scan_text_source_char_count: "{count} caractères",
        ...
        scan_pdf_source_label: "Fichier : ", pattern_page_label: "Page {page}", pattern_image_label: "Image {index}", link_pdf_history: "Vos analyses →", history_back: "Retour", history_title: "Vos analyses", history_intro: "Toutes les analyses que vous avez déjà faites. Les privées sont marquées d'un 🔒.", history_empty: "Vous n'avez pas encore d'analyse.", history_unnamed_file: "fichier sans nom", history_section_pdf: "PDF", history_section_image: "Images", history_section_text: "Textes", history_unnamed_image: "image sans nom", history_unnamed_text: "texte sans titre", history_search_placeholder: "Rechercher dans toutes vos analyses...", history_no_match: "Aucun résultat pour cette recherche.", history_private_badge: "🔒 Privée", history_section_url: "Liens", history_unnamed_url: "lien sans titre", history_filter_all: "Toutes", history_filter_public: "Publiques", history_filter_private: "Privées", label_text_private: "Garder cette analyse privée (visible uniquement par vous)",
    ...
    ru: {
        ...
        account_aria_label: "Ваш аккаунт", credit_balance_label: "Баланс кредитов", account_back: "Назад", account_title: "Ваш аккаунт",
        ...
        alert_enter_link: "Введите ссылку!", alert_invalid_link: "Это не похоже на настоящую ссылку — она должна начинаться с http:// или https://", alert_paste_text: "Вставьте текст!", alert_choose_image: "Выберите изображение!", alert_image_too_large: "Этот файл слишком большой (лимит 8 МБ).",
        ...
        err_url_fetch_failed: "Не удалось получить содержимое этой страницы — такие проблемы случаются, когда сам сайт блокирует автоматический доступ (например, защита от ботов). Проверьте, что ссылка верна и общедоступна. Вы также можете скопировать текст статьи, вставить его в режиме «Текст» и указать ту же ссылку в поле «Необязательно: ссылка на источник» — это сработает независимо от этой проблемы, а заодно поможет другим, кто вставит ту же ссылку.",
        ...
        err_login_required: "Это приватный контент — войдите, чтобы его увидеть.",
        notice_privatize_denied: "Этот контент уже был публичным, поэтому сделать его приватным сейчас нельзя — вот публичный результат.",
        err_save_failed: "Не удалось сохранить результат анализа. Попробуйте снова.",
        err_too_many_failed_attempts: "Слишком много неудачных попыток анализа подряд (уровень блокировки: {tier}). Повторите попытку через {time}.",
        ...
        scan_not_found: "Такой анализ не найден.", scan_source_label: "Источник: ", scan_text_source_label: "Показать полный исходный текст", scan_text_source_char_count: "{count} симв.",
        ...
        scan_pdf_source_label: "Файл: ", pattern_page_label: "Страница {page}", pattern_image_label: "Изображение {index}", link_pdf_history: "Ваши анализы →", history_back: "Назад", history_title: "Ваши анализы", history_intro: "Все анализы, которые вы когда-либо делали. Приватные отмечены значком 🔒.", history_empty: "У вас пока нет ни одного анализа.", history_unnamed_file: "файл без названия", history_section_pdf: "PDF", history_section_image: "Изображения", history_section_text: "Тексты", history_unnamed_image: "изображение без названия", history_unnamed_text: "текст без названия", history_search_placeholder: "Искать во всех ваших анализах...", history_no_match: "Нет результатов для этого поиска.", history_private_badge: "🔒 Приватный", history_section_url: "Ссылки", history_unnamed_url: "ссылка без названия", history_filter_all: "Все", history_filter_public: "Публичные", history_filter_private: "Приватные", label_text_private: "Сохранить этот анализ как приватный (виден только вам)",
    ...
    zh: {
        ...
        account_aria_label: "您的账户", credit_balance_label: "积分余额", account_back: "返回", account_title: "您的账户",
        ...
        alert_enter_link: "请输入链接！", alert_invalid_link: "这看起来不是有效链接——必须以 http:// 或 https:// 开头。", alert_paste_text: "请粘贴一些文本！", alert_choose_image: "请选择一张图片！", alert_image_too_large: "这个文件太大了（限制 8 MB）。",
        ...
        err_url_fetch_failed: "无法获取该页面的内容——当该网站本身阻止自动访问时(例如反爬虫防护)就会出现这类问题。请检查链接是否正确且可公开访问。你也可以复制文章文本，粘贴到「文本」模式中，并在「可选:来源链接」字段中填入同一个链接——这不受此问题影响，还能帮助其他粘贴同一链接的人。",
        err_system_paused: "Gakori 暂时停止服务——我们的团队已经知晓并正在处理。请稍后再试。",
        err_login_required: "此内容为私密内容——请登录后查看。",
        notice_privatize_denied: "此内容此前已是公开的，现在无法将其设为私密——这是公开结果。",
        err_save_failed: "无法保存分析结果，请重试。",
        err_too_many_failed_attempts: "连续太多次分析失败（封锁等级：{tier}）。请在 {time} 后重试。",
        ...
        scan_not_found: "未找到该分析。", scan_source_label: "来源：", scan_text_source_label: "显示完整原文", scan_text_source_char_count: "{count} 字符",
        ...
        scan_pdf_source_label: "文件：", pattern_page_label: "第 {page} 页", pattern_image_label: "图片 {index}", link_pdf_history: "你的分析 →", history_back: "返回", history_title: "你的分析", history_intro: "你做过的所有分析。私密的会标有 🔒。", history_empty: "你还没有任何分析。", history_unnamed_file: "未命名文件", history_section_pdf: "PDF", history_section_image: "图片", history_section_text: "文本", history_unnamed_image: "未命名图片", history_unnamed_text: "未命名文本", history_search_placeholder: "在你所有的分析中搜索...", history_no_match: "没有找到匹配结果。", history_private_badge: "🔒 私密", history_section_url: "链接", history_unnamed_url: "未命名链接", history_filter_all: "全部", history_filter_public: "公开", history_filter_private: "私密", label_text_private: "将此分析保存为私密(仅你可见)",
    ...
    ja: {
        ...
        account_aria_label: "アカウント", credit_balance_label: "クレジット残高", account_back: "戻る", account_title: "アカウント",
        ...
        alert_enter_link: "リンクを入力してください！", alert_invalid_link: "これは有効なリンクではないようです — http:// または https:// で始まる必要があります。", alert_paste_text: "テキストを貼り付けてください！", alert_choose_image: "画像を選択してください！", alert_image_too_large: "このファイルは大きすぎます（上限8MB）。",
        ...
        err_url_fetch_failed: "このページの内容を取得できませんでした — このような問題は、サイト側が自動アクセスをブロックしている場合(例:ボット対策)に起こります。リンクが正しく、一般公開されているか確認してください。記事のテキストをコピーして「テキスト」モードに貼り付け、「任意:出典リンク」欄に同じリンクを入力することもできます — この問題とは関係なく動作するうえ、同じリンクを貼る他の人の助けにもなります。",
        err_system_paused: "Gakoriは一時的に停止しています — チームはすでに把握しており、対応中です。しばらくしてからもう一度お試しください。",
        err_login_required: "これは非公開のコンテンツです — ログインしてご覧ください。",
        notice_privatize_denied: "この内容はすでに公開されていたため、今から非公開にすることはできません — こちらが公開結果です。",
        err_save_failed: "分析結果を保存できませんでした。もう一度お試しください。",
        err_too_many_failed_attempts: "分析の失敗が続きました(ブロックレベル: {tier})。{time}後にもう一度お試しください。",
        ...
        scan_not_found: "この分析結果は見つかりませんでした。", scan_source_label: "出典：", scan_text_source_label: "元のテキスト全文を表示", scan_text_source_char_count: "{count} 文字",
        ...
        scan_pdf_source_label: "ファイル：", pattern_page_label: "{page} ページ", pattern_image_label: "画像 {index}", link_pdf_history: "あなたの分析 →", history_back: "戻る", history_title: "あなたの分析", history_intro: "これまでに行ったすべての分析です。非公開のものには 🔒 が付きます。", history_empty: "まだ分析はありません。", history_unnamed_file: "名前のないファイル", history_section_pdf: "PDF", history_section_image: "画像", history_section_text: "テキスト", history_unnamed_image: "名前のない画像", history_unnamed_text: "無題のテキスト", history_search_placeholder: "すべての分析から検索...", history_no_match: "この検索に一致する結果はありません。", history_private_badge: "🔒 非公開", history_section_url: "リンク", history_unnamed_url: "無題のリンク", history_filter_all: "すべて", history_filter_public: "公開", history_filter_private: "非公開", label_text_private: "この分析を非公開として保存する(あなただけが閲覧できます)",
    ...
    hi: {
        ...
        account_aria_label: "आपका खाता", credit_balance_label: "क्रेडिट बैलेंस", account_back: "वापस", account_title: "आपका खाता",
        ...
        alert_enter_link: "एक लिंक दर्ज करें!", alert_invalid_link: "यह एक वैध लिंक नहीं लगता — इसे http:// या https:// से शुरू होना चाहिए।", alert_paste_text: "कुछ टेक्स्ट पेस्ट करें!", alert_choose_image: "एक छवि चुनें!", alert_image_too_large: "यह फ़ाइल बहुत बड़ी है (सीमा 8 MB)।",
        ...
        err_url_fetch_failed: "हम इस पेज की सामग्री प्राप्त नहीं कर सके — ऐसी समस्याएं तब होती हैं जब कोई साइट खुद स्वचालित पहुंच को रोकती है (जैसे बॉट-रोधी सुरक्षा)। जांचें कि लिंक सही है और सार्वजनिक रूप से उपलब्ध है। आप लेख का टेक्स्ट कॉपी करके “टेक्स्ट” मोड में पेस्ट कर सकते हैं और वही लिंक “वैकल्पिक: स्रोत लिंक” फ़ील्ड में भी डाल सकते हैं — यह इस समस्या के बावजूद काम करेगा, और उसी लिंक को पेस्ट करने वाले दूसरों की भी मदद करेगा।",
        ...
        err_login_required: "यह सामग्री निजी है — इसे देखने के लिए लॉग इन करें।",
        notice_privatize_denied: "यह सामग्री पहले से ही सार्वजनिक थी, इसलिए अब इसे निजी नहीं बनाया जा सकता — यह रहा सार्वजनिक परिणाम।",
        err_save_failed: "विश्लेषण परिणाम सहेजा नहीं जा सका। कृपया पुनः प्रयास करें।",
        err_too_many_failed_attempts: "लगातार बहुत सारे विश्लेषण प्रयास असफल हुए (ब्लॉक स्तर: {tier})। {time} बाद फिर कोशिश करें।",
        ...
        scan_not_found: "यह विश्लेषण नहीं मिला।", scan_source_label: "स्रोत: ", scan_text_source_label: "पूरा स्रोत टेक्स्ट दिखाएं", scan_text_source_char_count: "{count} अक्षर",
        ...
        scan_pdf_source_label: "फ़ाइल: ", pattern_page_label: "पृष्ठ {page}", pattern_image_label: "छवि {index}", link_pdf_history: "आपके विश्लेषण →", history_back: "वापस", history_title: "आपके विश्लेषण", history_intro: "आपने अब तक जितने भी विश्लेषण किए हैं, वे सभी। निजी वाले 🔒 से चिह्नित हैं।", history_empty: "अभी तक आपका कोई विश्लेषण नहीं है।", history_unnamed_file: "बिना नाम वाली फ़ाइल", history_section_pdf: "PDF", history_section_image: "छवियाँ", history_section_text: "टेक्स्ट", history_unnamed_image: "बिना नाम वाली छवि", history_unnamed_text: "बिना शीर्षक वाला टेक्स्ट", history_search_placeholder: "अपने सभी विश्लेषणों में खोजें...", history_no_match: "इस खोज के लिए कोई परिणाम नहीं मिला।", history_private_badge: "🔒 निजी", history_section_url: "लिंक", history_unnamed_url: "बिना शीर्षक वाला लिंक", history_filter_all: "सभी", history_filter_public: "सार्वजनिक", history_filter_private: "निजी", label_text_private: "इस विश्लेषण को निजी रखें (केवल आपको दिखाई देगा)",
    ...
    ar: {
        ...
        account_aria_label: "حسابك", credit_balance_label: "رصيد الأرصدة", account_back: "رجوع", account_title: "حسابك",
        ...
        alert_enter_link: "أدخل رابطًا!", alert_invalid_link: "هذا لا يبدو رابطًا صالحًا — يجب أن يبدأ بـ http:// أو https://", alert_paste_text: "الصق بعض النص!", alert_choose_image: "اختر صورة!", alert_image_too_large: "هذا الملف كبير جدًا (الحد الأقصى 8 ميغابايت).",
        ...
        err_url_fetch_failed: "تعذّر جلب محتوى هذه الصفحة — تحدث مثل هذه المشكلات عندما يحظر الموقع نفسه الوصول الآلي (مثل الحماية من الروبوتات). تحقق من أن الرابط صحيح ومتاح للجميع. يمكنك أيضًا نسخ نص المقال، ولصقه في وضع «نص»، وإضافة نفس الرابط في حقل «اختياري: رابط المصدر» — سيعمل ذلك بغض النظر عن هذه المشكلة، وسيساعد أيضًا الآخرين الذين سيلصقون نفس الرابط.",
        err_system_paused: "تم إيقاف Gakori مؤقتًا — فريقنا يعلم بالأمر بالفعل ويعمل على حله. يرجى المحاولة مرة أخرى بعد قليل.",
        err_login_required: "هذا المحتوى خاص — سجّل الدخول لعرضه.",
        notice_privatize_denied: "كان هذا المحتوى عامًا بالفعل من قبل، لذا لا يمكن جعله خاصًا الآن — إليك النتيجة العامة.",
        err_save_failed: "تعذّر حفظ نتيجة التحليل. حاول مرة أخرى.",
        err_too_many_failed_attempts: "عدد كبير جدًا من محاولات التحليل الفاشلة المتتالية (مستوى الحظر: {tier}). حاول مرة أخرى بعد {time}.",
        ...
        scan_not_found: "لم يتم العثور على هذا التحليل.", scan_source_label: "المصدر: ", scan_text_source_label: "عرض النص المصدر الكامل", scan_text_source_char_count: "{count} حرف",
        ...
        scan_pdf_source_label: "الملف: ", pattern_page_label: "الصفحة {page}", pattern_image_label: "الصورة {index}", link_pdf_history: "تحليلاتك →", history_back: "رجوع", history_title: "تحليلاتك", history_intro: "كل التحليلات التي أجريتها على الإطلاق. الخاصة منها مُعلَّمة بـ 🔒.", history_empty: "ليس لديك أي تحليل بعد.", history_unnamed_file: "ملف بدون اسم", history_section_pdf: "PDF", history_section_image: "الصور", history_section_text: "نصوص", history_unnamed_image: "صورة بدون اسم", history_unnamed_text: "نص بدون عنوان", history_search_placeholder: "ابحث في جميع تحليلاتك...", history_no_match: "لا توجد نتائج لهذا البحث.", history_private_badge: "🔒 خاص", history_section_url: "روابط", history_unnamed_url: "رابط بدون عنوان", history_filter_all: "الكل", history_filter_public: "عامة", history_filter_private: "خاصة", label_text_private: "احتفظ بهذا التحليل كخاص (يظهر لك فقط)",
