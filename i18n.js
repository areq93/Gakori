...
const TRANSLATIONS = {
    pl: {
        ...
        scan_pdf_source_label: "Plik: ", pattern_page_label: "Strona {page}", pattern_image_label: "Obraz {index}", link_pdf_history: "Twoje prywatne analizy →", history_back: "Wstecz", history_title: "Twoje prywatne analizy", history_intro: "Tylko Ty widzisz tę listę — te analizy nie są publiczne.", history_empty: "Nie masz jeszcze żadnych prywatnych analiz.", history_unnamed_file: "plik bez nazwy", history_section_pdf: "PDF-y", history_section_image: "Obrazy", history_section_text: "Prywatne teksty", history_unnamed_image: "obraz bez nazwy", history_unnamed_text: "prywatny tekst", history_search_placeholder: "Szukaj we wszystkich swoich analizach...", history_no_match: "Brak wyników dla tego wyszukiwania.", history_now_public: "🌐 Teraz publiczna", label_text_private: "Zachowaj tę analizę jako prywatną (widoczna tylko dla Ciebie)",
    ...
    es: {
        ...
        scan_pdf_source_label: "Archivo: ", pattern_page_label: "Página {page}", pattern_image_label: "Imagen {index}", link_pdf_history: "Tus análisis privados →", history_back: "Atrás", history_title: "Tus análisis privados", history_intro: "Solo tú puedes ver esta lista — estos análisis no son públicos.", history_empty: "Todavía no tienes ningún análisis privado.", history_unnamed_file: "archivo sin nombre", history_section_pdf: "PDF", history_section_image: "Imágenes", history_section_text: "Textos privados", history_unnamed_image: "imagen sin nombre", history_unnamed_text: "texto privado", history_search_placeholder: "Buscar en todos tus análisis...", history_no_match: "Sin resultados para esta búsqueda.", history_now_public: "🌐 Ahora pública", label_text_private: "Guardar este análisis como privado (solo tú lo verás)",
    ...
    de: {
        ...
        scan_pdf_source_label: "Datei: ", pattern_page_label: "Seite {page}", pattern_image_label: "Bild {index}", link_pdf_history: "Deine privaten Analysen →", history_back: "Zurück", history_title: "Deine privaten Analysen", history_intro: "Nur du siehst diese Liste — diese Analysen sind nicht öffentlich.", history_empty: "Du hast noch keine privaten Analysen.", history_unnamed_file: "Datei ohne Namen", history_section_pdf: "PDFs", history_section_image: "Bilder", history_section_text: "Private Texte", history_unnamed_image: "Bild ohne Namen", history_unnamed_text: "privater Text", history_search_placeholder: "In allen deinen Analysen suchen...", history_no_match: "Keine Ergebnisse für diese Suche.", history_now_public: "🌐 Jetzt öffentlich", label_text_private: "Diese Analyse privat halten (nur für dich sichtbar)",
    ...
    fr: {
        ...
        scan_pdf_source_label: "Fichier : ", pattern_page_label: "Page {page}", pattern_image_label: "Image {index}", link_pdf_history: "Vos analyses privées →", history_back: "Retour", history_title: "Vos analyses privées", history_intro: "Vous seul voyez cette liste — ces analyses ne sont pas publiques.", history_empty: "Vous n'avez pas encore d'analyse privée.", history_unnamed_file: "fichier sans nom", history_section_pdf: "PDF", history_section_image: "Images", history_section_text: "Textes privés", history_unnamed_image: "image sans nom", history_unnamed_text: "texte privé", history_search_placeholder: "Rechercher dans toutes vos analyses...", history_no_match: "Aucun résultat pour cette recherche.", history_now_public: "🌐 Désormais publique", label_text_private: "Garder cette analyse privée (visible uniquement par vous)",
    ...
    ru: {
        ...
        scan_pdf_source_label: "Файл: ", pattern_page_label: "Страница {page}", pattern_image_label: "Изображение {index}", link_pdf_history: "Ваши приватные анализы →", history_back: "Назад", history_title: "Ваши приватные анализы", history_intro: "Этот список видите только вы — эти анализы не публичные.", history_empty: "У вас пока нет ни одного приватного анализа.", history_unnamed_file: "файл без названия", history_section_pdf: "PDF", history_section_image: "Изображения", history_section_text: "Приватные тексты", history_unnamed_image: "изображение без названия", history_unnamed_text: "приватный текст", history_search_placeholder: "Искать во всех ваших анализах...", history_no_match: "Нет результатов для этого поиска.", history_now_public: "🌐 Теперь публичная", label_text_private: "Сохранить этот анализ как приватный (виден только вам)",
    ...
    zh: {
        ...
        scan_pdf_source_label: "文件：", pattern_page_label: "第 {page} 页", pattern_image_label: "图片 {index}", link_pdf_history: "你的私密分析 →", history_back: "返回", history_title: "你的私密分析", history_intro: "只有你能看到这份列表——这些分析不公开。", history_empty: "你还没有任何私密分析。", history_unnamed_file: "未命名文件", history_section_pdf: "PDF", history_section_image: "图片", history_section_text: "私密文本", history_unnamed_image: "未命名图片", history_unnamed_text: "私密文本", history_search_placeholder: "在你所有的分析中搜索...", history_no_match: "没有找到匹配结果。", history_now_public: "🌐 现已公开", label_text_private: "将此分析保存为私密(仅你可见)",
    ...
    ja: {
        ...
        scan_pdf_source_label: "ファイル：", pattern_page_label: "{page} ページ", pattern_image_label: "画像 {index}", link_pdf_history: "あなたの非公開分析 →", history_back: "戻る", history_title: "あなたの非公開分析", history_intro: "このリストはあなただけが見ることができます — これらの分析は公開されません。", history_empty: "まだ非公開の分析はありません。", history_unnamed_file: "名前のないファイル", history_section_pdf: "PDF", history_section_image: "画像", history_section_text: "非公開テキスト", history_unnamed_image: "名前のない画像", history_unnamed_text: "非公開テキスト", history_search_placeholder: "すべての分析から検索...", history_no_match: "この検索に一致する結果はありません。", history_now_public: "🌐 現在は公開中", label_text_private: "この分析を非公開として保存する(あなただけが閲覧できます)",
    ...
    hi: {
        ...
        scan_pdf_source_label: "फ़ाइल: ", pattern_page_label: "पृष्ठ {page}", pattern_image_label: "छवि {index}", link_pdf_history: "आपके निजी विश्लेषण →", history_back: "वापस", history_title: "आपके निजी विश्लेषण", history_intro: "यह सूची केवल आप देख सकते हैं — ये विश्लेषण सार्वजनिक नहीं होते।", history_empty: "अभी तक आपका कोई निजी विश्लेषण नहीं है।", history_unnamed_file: "बिना नाम वाली फ़ाइल", history_section_pdf: "PDF", history_section_image: "छवियाँ", history_section_text: "निजी टेक्स्ट", history_unnamed_image: "बिना नाम वाली छवि", history_unnamed_text: "निजी टेक्स्ट", history_search_placeholder: "अपने सभी विश्लेषणों में खोजें...", history_no_match: "इस खोज के लिए कोई परिणाम नहीं मिला।", history_now_public: "🌐 अब सार्वजनिक", label_text_private: "इस विश्लेषण को निजी रखें (केवल आपको दिखाई देगा)",
    ...
    ar: {
        ...
        scan_pdf_source_label: "الملف: ", pattern_page_label: "الصفحة {page}", pattern_image_label: "الصورة {index}", link_pdf_history: "تحليلاتك الخاصة →", history_back: "رجوع", history_title: "تحليلاتك الخاصة", history_intro: "أنت فقط من يرى هذه القائمة — هذه التحليلات ليست عامة.", history_empty: "ليس لديك أي تحليل خاص بعد.", history_unnamed_file: "ملف بدون اسم", history_section_pdf: "PDF", history_section_image: "الصور", history_section_text: "نصوص خاصة", history_unnamed_image: "صورة بدون اسم", history_unnamed_text: "نص خاص", history_search_placeholder: "ابحث في جميع تحليلاتك...", history_no_match: "لا توجد نتائج لهذا البحث.", history_now_public: "🌐 أصبحت عامة الآن", label_text_private: "احتفظ بهذا التحليل كخاص (يظهر لك فقط)",
