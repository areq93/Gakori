...
const TRANSLATIONS = {
    pl: {
        ...
        scan_not_found: "Nie znaleziono takiej analizy.", scan_source_label: "Źródło: ", scan_text_source_label: "Pokaż pełny tekst źródłowy", btn_copy_source_text: "Kopiuj", btn_copy_source_text_done: "Skopiowano!", scan_text_source_char_count: "{count} znaków", btn_analyze_as_text: "Analizuj jako tekst",
    ...
    en: {
        ...
        scan_not_found: "This analysis could not be found.", scan_source_label: "Source: ", scan_text_source_label: "Show full source text", btn_copy_source_text: "Copy", btn_copy_source_text_done: "Copied!", scan_text_source_char_count: "{count} characters", btn_analyze_as_text: "Analyze as text",
    ...
    es: {
        ...
        scan_not_found: "No se encontró este análisis.", scan_source_label: "Fuente: ", scan_text_source_label: "Mostrar el texto fuente completo", btn_copy_source_text: "Copiar", btn_copy_source_text_done: "¡Copiado!", scan_text_source_char_count: "{count} caracteres", btn_analyze_as_text: "Analizar como texto",
    ...
    de: {
        ...
        scan_not_found: "Diese Analyse wurde nicht gefunden.", scan_source_label: "Quelle: ", scan_text_source_label: "Vollständigen Quelltext anzeigen", btn_copy_source_text: "Kopieren", btn_copy_source_text_done: "Kopiert!", scan_text_source_char_count: "{count} Zeichen", btn_analyze_as_text: "Als Text analysieren",
    ...
    fr: {
        ...
        scan_not_found: "Cette analyse est introuvable.", scan_source_label: "Source : ", scan_text_source_label: "Afficher le texte source complet", btn_copy_source_text: "Copier", btn_copy_source_text_done: "Copié !", scan_text_source_char_count: "{count} caractères", btn_analyze_as_text: "Analyser comme texte",
    ...
    ru: {
        ...
        scan_not_found: "Такой анализ не найден.", scan_source_label: "Источник: ", scan_text_source_label: "Показать полный исходный текст", btn_copy_source_text: "Копировать", btn_copy_source_text_done: "Скопировано!", scan_text_source_char_count: "{count} симв.", btn_analyze_as_text: "Анализировать как текст",
    ...
    zh: {
        ...
        scan_not_found: "未找到该分析。", scan_source_label: "来源：", scan_text_source_label: "显示完整原文", btn_copy_source_text: "复制", btn_copy_source_text_done: "已复制！", scan_text_source_char_count: "{count} 字符", btn_analyze_as_text: "作为文本分析",
    ...
    ja: {
        ...
        scan_not_found: "この分析結果は見つかりませんでした。", scan_source_label: "出典：", scan_text_source_label: "元のテキスト全文を表示", btn_copy_source_text: "コピー", btn_copy_source_text_done: "コピーしました！", scan_text_source_char_count: "{count} 文字", btn_analyze_as_text: "テキストとして分析",
    ...
    hi: {
        ...
        scan_not_found: "यह विश्लेषण नहीं मिला।", scan_source_label: "स्रोत: ", scan_text_source_label: "पूरा स्रोत टेक्स्ट दिखाएं", btn_copy_source_text: "कॉपी करें", btn_copy_source_text_done: "कॉपी हो गया!", scan_text_source_char_count: "{count} अक्षर", btn_analyze_as_text: "टेक्स्ट के रूप में विश्लेषण करें",
    ...
    ar: {
        ...
        scan_not_found: "لم يتم العثور على هذا التحليل.", scan_source_label: "المصدر: ", scan_text_source_label: "عرض النص المصدر الكامل", btn_copy_source_text: "نسخ", btn_copy_source_text_done: "تم النسخ!", scan_text_source_char_count: "{count} حرف", btn_analyze_as_text: "تحليل كنص",
