...
const TRANSLATIONS = {
    pl: {
        ...
        scan_pdf_source_label: "Plik: ", pattern_page_label: "Strona {page}", pattern_image_label: "Obraz {index}", link_pdf_history: "Twoje prywatne analizy →", history_back: "← Wstecz", history_title: "Twoje prywatne analizy", history_intro: "Tylko Ty widzisz tę listę — te analizy nie są publiczne.", history_empty: "Nie masz jeszcze żadnych prywatnych analiz.", history_unnamed_file: "plik bez nazwy", history_section_pdf: "PDF-y", history_section_image: "Obrazy", history_section_text: "Prywatne teksty", history_unnamed_image: "obraz bez nazwy", history_unnamed_text: "prywatny tekst", history_search_placeholder: "Szukaj we wszystkich swoich analizach...", history_no_match: "Brak wyników dla tego wyszukiwania.", label_text_private: "Zachowaj tę analizę jako prywatną (widoczna tylko dla Ciebie)",
    ...
    hi: {
        ...
        scan_pdf_source_label: "फ़ाइल: ", pattern_page_label: "पृष्ठ {page}", pattern_image_label: "छवि {index}", link_pdf_history: "आपके निजी विश्लेषण →", history_back: "← वापस", history_title: "आपके निजी विश्लेषण", history_intro: "यह सूची केवल आप देख सकते हैं — ये विश्लेषण सार्वजनिक नहीं होते।", history_empty: "अभी तक आपका कोई निजी विश्लेषण नहीं है।", history_unnamed_file: "बिना नाम वाली फ़ाइल", history_section_pdf: "PDF", history_section_image: "छवियाँ", history_section_text: "निजी टेक्स्ट", history_unnamed_image: "बिना नाम वाली छवि", history_unnamed_text: "निजी टेक्स्ट", history_search_placeholder: "अपने सभी विश्लेषणों में खोजें...", history_no_match: "इस खोज के लिए कोई परिणाम नहीं मिला।", label_text_private: "इस विश्लेषण को निजी रखें (केवल आपको दिखाई देगा)",
