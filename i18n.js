...
const TRANSLATIONS = {
    pl: {
        ...
        label_pasted_image: "Wklejony obraz ({size} KB)",
        alert_paste_not_image: "To, co wkleiłeś, nie jest obrazem.",
    ...
    en: {
        ...
        label_pasted_image: "Pasted image ({size} KB)",
        alert_paste_not_image: "What you pasted isn't an image.",
    ...
    es: {
        ...
        label_pasted_image: "Imagen pegada ({size} KB)",
        alert_paste_not_image: "Lo que has pegado no es una imagen.",
    ...
    de: {
        ...
        label_pasted_image: "Eingefügtes Bild ({size} KB)",
        alert_paste_not_image: "Das Eingefügte ist kein Bild.",
    ...
    fr: {
        ...
        label_pasted_image: "Image collée ({size} KB)",
        alert_paste_not_image: "Ce que vous avez collé n'est pas une image.",
    ...
    ru: {
        ...
        label_pasted_image: "Вставленное изображение ({size} КБ)",
        alert_paste_not_image: "То, что вы вставили, не является изображением.",
    ...
    zh: {
        ...
        label_pasted_image: "已粘贴的图片（{size} KB）",
        alert_paste_not_image: "你粘贴的内容不是图片。",
    ...
    ja: {
        ...
        label_pasted_image: "貼り付けた画像（{size}KB）",
        alert_paste_not_image: "貼り付けたものは画像ではありません。",
    ...
    hi: {
        ...
        label_pasted_image: "चिपकाई गई छवि ({size} KB)",
        alert_paste_not_image: "आपने जो चिपकाया वह एक छवि नहीं है।",
    ...
    ar: {
        ...
        label_pasted_image: "الصورة الملصقة ({size} كيلوبايت)",
        alert_paste_not_image: "الشيء الذي لصقته ليس صورة.",
