...
const TRANSLATIONS = {
    ...
    es: {
        ...
        scan_pdf_source_label: "Archivo: ", pattern_page_label: "Página {page}", link_pdf_history: "Tus análisis de PDF →", history_back: "← Volver a la cuenta", history_title: "Tus análisis de PDF", history_intro: "Solo tú puedes ver esta lista — los análisis de PDF no son públicos.", history_empty: "Todavía no tienes ningún análisis de PDF.", history_unnamed_file: "archivo sin nombre",
    ...
    de: {
        ...
        scan_pdf_source_label: "Datei: ", pattern_page_label: "Seite {page}", link_pdf_history: "Deine PDF-Analysen →", history_back: "← Zurück zum Konto", history_title: "Deine PDF-Analysen", history_intro: "Nur du siehst diese Liste — PDF-Analysen sind nicht öffentlich.", history_empty: "Du hast noch keine PDF-Analysen.", history_unnamed_file: "Datei ohne Namen",
    ...
    ru: {
        ...
        scan_pdf_source_label: "Файл: ", pattern_page_label: "Страница {page}", link_pdf_history: "Ваши анализы PDF →", history_back: "← Назад в аккаунт", history_title: "Ваши анализы PDF", history_intro: "Этот список видите только вы — анализы PDF не публичные.", history_empty: "У вас пока нет ни одного анализа PDF.", history_unnamed_file: "файл без названия",
    ...
    zh: {
        ...
        scan_pdf_source_label: "文件：", pattern_page_label: "第 {page} 页", link_pdf_history: "你的 PDF 分析 →", history_back: "← 返回账户", history_title: "你的 PDF 分析", history_intro: "只有你能看到这份列表——PDF 分析不公开。", history_empty: "你还没有任何 PDF 分析。", history_unnamed_file: "未命名文件",
    ...
    ja: {
        ...
        scan_pdf_source_label: "ファイル：", pattern_page_label: "{page} ページ", link_pdf_history: "あなたのPDF分析 →", history_back: "← アカウントに戻る", history_title: "あなたのPDF分析", history_intro: "このリストはあなただけが見ることができます — PDFの分析は公開されません。", history_empty: "まだPDFの分析はありません。", history_unnamed_file: "名前のないファイル",
    ...
    ar: {
        ...
        scan_pdf_source_label: "الملف: ", pattern_page_label: "الصفحة {page}", link_pdf_history: "تحليلات PDF الخاصة بك →", history_back: "← العودة إلى الحساب", history_title: "تحليلات PDF الخاصة بك", history_intro: "أنت فقط من يرى هذه القائمة — تحليلات PDF ليست عامة.", history_empty: "ليس لديك أي تحليل PDF بعد.", history_unnamed_file: "ملف بدون اسم",
